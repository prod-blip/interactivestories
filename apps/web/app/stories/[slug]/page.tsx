  ...
  return (
    <main className="detail-page">
      ...
      <section className="shell detail-hero">
        <div className="detail-art"><StoryArtwork compact variant={story.slug === 'crow-and-pitcher' ? 'crow-and-pitcher' : story.slug === 'tortoise-and-rabbit' ? 'tortoise-and-rabbit' : story.slug === 'tortoise-and-tiger' ? 'tortoise-and-tiger' : 'mouse-and-lion'} /></div>
